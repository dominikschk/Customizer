...
const KeychainGeometry = forwardRef<THREE.Mesh, { logoConfig: LogoConfig }>(({ logoConfig }, ref) => {
  ...
  return (
    // Apply rotation to the entire group so coordinate systems align (XY is face, Z is depth)
...
export const Viewer3D = forwardRef<Viewer3DHandle, Keychain3DProps>(({ logoConfig, detectedColors }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        downloadSTL: () => {
            ...
            // because converting a 2D image to a manifold 3D mesh in browser is highly error-prone.
